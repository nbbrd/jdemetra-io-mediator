...
public final class MediatorProvider extends AbstractDataSourceProvider<List<MediatorAlias>> {

    public static final String NAME = "MEDIATOR", VERSION = "20150814";
    ...
    public MediatorProvider() {
        super(LoggerFactory.getLogger(MediatorProvider.class), NAME, TsAsyncMode.Once);
        this.connectionSupplier = MediatorConnectionSupplier.noOp();
    }
    ...
    public void setConnectionSupplier(@Nullable MediatorConnectionSupplier connectionSupplier) {
        this.connectionSupplier = connectionSupplier != null ? connectionSupplier : MediatorConnectionSupplier.noOp();
        updateDataSources();
    }
    ...
    private void updateDataSources() {
        try (MediatorConnection conn = connectionSupplier.getConnection()) {
            support.closeAll();
            DataSource.Builder b = DataSource.builder(NAME, VERSION);
